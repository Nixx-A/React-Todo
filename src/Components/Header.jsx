    ...
    <header className=''>
      <div className='flex justify-between items-center'>
        ...
        <button
          ...
          className='text-1xl relative right-1 top-0.5 shadow-lg border rounded-full  hover:shadow-lg bg-white p-1'>
          {darkTheme ? (
            <BsSun data-testid='light-theme-icon' className='text-black' />
          ) : (
            <FiMoon className='' />
          )}
        </button>
